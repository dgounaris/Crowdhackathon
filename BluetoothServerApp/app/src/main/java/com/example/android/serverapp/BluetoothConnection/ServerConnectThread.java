package com.example.android.serverapp.BluetoothConnection;
...
/**
 * Created by antonis on 06-Aug-17.
 */
...
public class ServerConnectThread extends Thread {
    ...
    public void acceptConnect(BluetoothAdapter bTAdapter, UUID mUUID) {
        ...
        try {
            temp = bTAdapter.listenUsingRfcommWithServiceRecord("Bluetooth_connection", mUUID);
        } catch (IOException e) {
